...
public class MapCaptchaStore implements CaptchaStore {
     ...
     *
     * @throws CaptchaServiceException if the captcha already exists, or if an
     * error occurs during storing routine.
     */
...
//        }
     ...
     * @throws com.octo.captcha.service.CaptchaServiceException if the captcha
     * already exists, or if an error occurs during storing routine.
     */
     ...
     *
     * @throws CaptchaServiceException if a captcha for this key is not found or
     ...
     * @throws com.octo.captcha.service.CaptchaServiceException if an error
     * occurs during retrieving routine.
     */
